...
public static class UpdateService
{
    ...
    private const string Repo = "KeyLangSwitcher";
        ...
        ReleaseInfo release, IProgress<int>? progress = null, CancellationToken ct = default)
    {
        ...
        var dir = Path.Combine(Path.GetTempPath(), "KeyLangSwitcherUpdate");
        Directory.CreateDirectory(dir);
        var path = Path.Combine(dir, $"KeyLangSwitcher-{release.TagName}-setup.exe");
